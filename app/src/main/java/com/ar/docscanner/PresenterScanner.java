...
import com.ar.docscanner.Interfaces.IPresenterScanner;
import com.ar.docscanner.Interfaces.IViewScanner;
import com.ar.docscanner.libary.PolygonView;
import com.ar.docscanner.util.ImageUtils;
import com.ar.docscanner.util.PathUtil;
...
public class PresenterScanner implements IPresenterScanner {
    public static String FOLDER_NAME = "/DocScanner/";
