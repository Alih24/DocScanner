...
import com.ar.docscanner.process.adapter.PDFAdapter;
...
public class MyPDFActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        folder = new File(Environment.getExternalStorageDirectory() + "/" + folderName + "/Document");
        if (!folder.exists()) {
            folder.mkdir();
        }
        ...
        adapter = new PDFAdapter(this, inFiles);
    ...
    public void showCustomView() {
        ...
        spinnerPageSize.setSelection(5); 
