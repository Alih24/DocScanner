...
public class HandleActivity extends BaseActivity implements com.joshuabutton.queenscanner.handle.HandleContract.IHandleView {
    @BindView(R.id.viewPager)
    com.joshuabutton.queenscanner.handle.HackyViewPager viewPager;
    @BindView(R.id.layout_bot)
    LinearLayout layoutBot;
    @BindView(R.id.layout_top)
    RelativeLayout layoutTop;
    private com.joshuabutton.queenscanner.handle.ViewPagerAdapter adapter;
    private com.joshuabutton.queenscanner.handle.HandleContract.IHandlePresenter presenter;
    ...
    protected void initView() {
        ...
        presenter = new com.joshuabutton.queenscanner.handle.HandlePresenter(this, this);
        adapter = new com.joshuabutton.queenscanner.handle.ViewPagerAdapter(HandleActivity.this, presenter);
